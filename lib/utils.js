...
utils.only = function only (obj, permitted_keys) {
  if (typeof obj !== 'object') {
    throw Error('ConfigureError: options must be of type Object');
  }

  if (!Array.isArray(permitted_keys)) {
    throw Error('ConfigureError: whitelisted properties must be an Array');
  }
